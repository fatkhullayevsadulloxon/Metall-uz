...
import Catalog3 from "../../../assets/img/pg-katalog3.jpg"

const ServisLinkLazer = () => {
            ...
            <ServisMain/>
                <div class="catalog-wrapper container">
                    <div class="catalog-table">
                        ...
                        <p class="catalog-table__discription-x">{Lang[til].ServisPage.ServisPageLinkDesc3}</p>
                        <img class="catalog-table__img-x" src={Catalog3} alt="img" width="324" height="384" />
                    </div>
                </div>
            </div>
    )
...
export default ServisLinkLazer