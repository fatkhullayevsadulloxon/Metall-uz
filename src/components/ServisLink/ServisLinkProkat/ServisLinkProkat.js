...
import Catalog5 from "../../../assets/img/pg-katalog5.jpg"

const ServisLinkProkat = () => {
            ...
            <ServisMain/>
                <div class="catalog-wrapper container">
                    <div class="catalog-table">
                        ...
                        <NavLink id="1" to="/servis/metall-prokat" className="btn-wrapper__btn btn-js button-active" type="button">{Lang[til].ServisPage.ServisPageLink5}</NavLink>
                        ...
                        <p class="catalog-table__discription-x">{Lang[til].ServisPage.ServisPageLinkDesc5}</p>
                        <img class="catalog-table__img-x" src={Catalog5} alt="img" width="324" height="384" />
                    </div>
                </div>
            </div>
    )
...
export default ServisLinkProkat