...
import Catalog6 from "../../../assets/img/pg-katalog6.jpg"

const ServisLinkProkatLazer = () => {
            ...
            <ServisMain/>
                <div class="catalog-wrapper container">
                    <div class="catalog-table">
                        ...
                        <NavLink id="1" to="/servis/metal-prokat-lazer" className="btn-wrapper__btn btn-js button-active" type="button">{Lang[til].ServisPage.ServisPageLink6}</NavLink>
                        </div>
                        <p class="catalog-table__discription-x">{Lang[til].ServisPage.ServisPageLinkDesc6}</p>
                        <img class="catalog-table__img-x" src={Catalog6} alt="img" width="324" height="384" />
                    </div>
                </div>
            </div>
    )
...
export default ServisLinkProkatLazer